...
const EventCard = ({ eventId }: EventCardProps) => {
  ...
  const renderQueuePosition = () => {
    if (!queuePosition || queuePosition.status !== WAITING_LIST_STATUS.WAITING) return null;
    if (availability.purchasedCount >= availability.totalTickets) {
      return (
        <div className="flex items-center p-3 justify-between bg-gray-50 rounded-lg border border-gray-200">
    ...
    if (queuePosition.position === 2) {
      <div className="flex flex-col lg:flex-row items-center justify-center p-3 bg-amber-50 rounded-lg border border-amber-100">
        <div className="flex items-center">
